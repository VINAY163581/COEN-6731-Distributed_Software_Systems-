error id: file://<WORKSPACE>/src/main/scala/com/analytics/MainApp.scala:
...
import com.analytics.session.SparkSessionBuilder

object MainApp {

  def main(args: Array[String]): Unit = {

    val spark = SparkSessionBuilder.build("Ecommerce Analytics")
